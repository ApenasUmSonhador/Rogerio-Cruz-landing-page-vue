            ...
            <div class="grid md:grid-cols-2">
                <div class="flex flex-col md:flex-row md:space-x-12 items-center">
                    ...
                    <ul
                        ...
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#about-section" v-smooth-scroll>Sensei Rogério</a>
                        </li>
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#faq" v-smooth-scroll>Perguntas frequentes</a>
                        </li>
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                ...
                <div class="md:place-self-end place-self-center mt-10 md:mt-0">
                    <ul class="flex space-x-8 items-center">
                        <li>
                            <a href="https://www.facebook.com/judorogeriocruz/" target="_blank">
                        ...
                        <li>
                            <a href="https://www.instagram.com/judo_rogerio_cruz/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
