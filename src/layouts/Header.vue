...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/">
                    <img src="/images/escudo-2.svg" width="100" alt="Logo Sensei Rogério">
                </a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#about-section"
                            v-smooth-scroll>Sensei Rogério</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#faq"
                            v-smooth-scroll>Perguntas frequentes</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#contact"
                            v-smooth-scroll>Contato</a></li>
                    <li
                        ...
                        <a href="#subscribe-section" v-smooth-scroll>Inscreva-se!</a>
                    </li>
                </ul>
            </nav>
        </header>
            ...
            <div
                ...
                <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
                    <li
                        ...
                        <a @click="toggleMobileNav()" href="#about-section">Sensei Rogério</a>
                    </li>
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a @click="toggleMobileNav()" href="#faq">Perguntas frequentes</a>
                    </li>
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a @click="toggleMobileNav()" href="#contact">Contato</a>
                    </li>
                    <li
                        ...
                        <a @click="toggleMobileNav()" href="#subscribe-section">Inscreva-se</a>
                    </li>
                </ul>
